          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                ...
                <br />
                <span className="text-gray-900 dark:text-white">Sourav</span>
              </h1>

              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-lg">
                Full-Stack Developer & Frontend Architect crafting exceptional digital experiences with modern
                technologies.
              </p>
            </div>
          ...
          >
            <div className="relative group">
              ...
              <div className="absolute -top-4 -right-4 bg-white dark:bg-gray-800 px-4 py-2 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 animate-float">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">6+ Years</span>
              </div>
              <div className="absolute -bottom-4 -left-4 bg-white dark:bg-gray-800 px-4 py-2 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 animate-float animation-delay-1000">
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">50+ Projects</span>
              </div>
            </div>
          </div>
        </div>
